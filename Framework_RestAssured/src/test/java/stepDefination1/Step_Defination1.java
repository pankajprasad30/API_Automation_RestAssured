...
public class Step_Defination1 {
	...
	@Given("User will send the payload with proper details")
	...
	public void user_will_hit_specific(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@Then("User will validate the response body and {string}")
	public void user_will_validate_the_response_body_and(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
